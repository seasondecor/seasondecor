...
import { useGetPaginatedAdminTransactions } from "@/app/queries/dashboard/dashboard.admin.query";
import {
  Skeleton,
  FormControl,
  InputLabel,
...
const ManageTransaction = () => {
  ...
  const typeOptions = [{ id: "", name: "All Types" }];
  ...
  const {
    ...
    error,
    refetch,
  } = useGetPaginatedAdminTransactions({
    ...pagination,
  ...
  const columns = [
    {
      ...
      cell: ({ row }) => <FootTypo footlabel={row.original.transactionId} />,
    },
    {
      header: "Date",
